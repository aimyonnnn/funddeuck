...
//        if (memberIdx == null) {
//            return "member/member_profile"; // 로그인 페이지로 리다이렉트 예시
//        }
//
...
//    }
    ...
    public String showProfilePage(Model model) {
        int memberIdx = 1; // 가정상 로그인 없이 member_idx가 1로 주어졌다고 가정
    ...
    private String saveProfileImage(MultipartFile profileImage) throws IOException {
        ...
        try {
            ...
            throw new IOException("사진 저장을 실패했습니다.", e);
        }
    }
