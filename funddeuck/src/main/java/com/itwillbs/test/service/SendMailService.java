...
//		String content = "인증코드 : " + authCode;
	...
	public boolean sendPasswdMail(String email, String authCode) {
		boolean isSendSuccess = false;
		
		
		// 제목과 본문 생성
		String subject = "Funddeuck 비밀번호 변경 안내 입니다.";
//		String content = "인증코드 : " + authCode;
		// 사용자가 링크를 클릭하면 인증 수행을 위한 서블릿 주소를 요청하도록 본문에 하이퍼링크를 포함
		String content = "<!DOCTYPE html>\r\n"
				+ "<html>\r\n"
				...
				+ "        <span class=\"subtitle\">Funddeuck</span>\r\n"
				+ "        <h1 class=\"title\">\r\n"
				+ "            <span class=\"point-text\">비밀번호 변경</span> 안내입니다.\r\n"
				+ "        </h1>\r\n"
				+ "        <p class=\"content\">\r\n"
				+ "            아래의 <b class=\"point-text\">'비밀번호 변경'</b>버튼을 눌러 진행하신 후 로그인 진행바랍니다.<br />\r\n"
				+ "            감사합니다.\r\n"
				+ "        </p>\r\n"
				+ "        <!-- 메일 인증 번호 -->\r\n"
