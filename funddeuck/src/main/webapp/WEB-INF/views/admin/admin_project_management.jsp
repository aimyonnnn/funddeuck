	...
	<div class="d-flex flex-row justify-content-center my-3">
		...
		<form action="adminProjectManagement" class="d-flex flex-row justify-content-end">
			...
			<select class="form-select form-select-sm me-2" name="searchType" id="searchType" style="width: 100px;">
				<option value="subject" <c:if test="${param.searchType eq 'subject'}">selected</c:if>>프로젝트명</option>
				<option value="name" <c:if test="${param.searchType eq 'name'}">selected</c:if>>대표자이름</option>
			</select>
			<!-- 검색타입, 검색어 -->
