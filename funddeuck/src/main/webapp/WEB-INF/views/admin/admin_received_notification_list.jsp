...
<jsp:include page="../common/admin_top.jsp"/>
	...
	<div class="container my-5">
		...
		<div class="d-flex flex-row justify-content-center my-3">
			<!-- 폼 태그 -->
			<form action="adminReceivedNotification" class="d-flex flex-row justify-content-end">
				<!-- 셀렉트 박스 -->
	                ...
	                <c:when test="${pageNum > 1}">
	                	<c:choose>
	                		<c:when test="${not empty param.searchType and not empty param.searchKeyword}">
		                        <a class="page-link" aria-label="Previous" href="adminReceivedNotification?pageNum=${pageNum - 1}&searchType=${param.searchType}&searchKeyword=${param.searchKeyword}">
		                            <span aria-hidden="true">&laquo;</span>
		                        </a>
	                		</c:when>
	                		<c:otherwise>
		                        <a class="page-link" aria-label="Previous" href="adminReceivedNotification?pageNum=${pageNum - 1}">
		                            <span aria-hidden="true">&laquo;</span>
		                        </a>
	                		</c:otherwise>
	                	</c:choose>
	            ...
	            <c:forEach var="i" begin="${pageInfo.startPage}" end="${pageInfo.endPage}">
	                <c:choose>
	                    ...
	                    <c:otherwise>
	                        ...
	                        <c:choose>
	                            <c:when test="${not empty param.searchType and not empty param.searchKeyword}">
	                                <li class="page-item"><a class="page-link" href="adminReceivedNotification?pageNum=${i}&searchType=${param.searchType}&searchKeyword=${param.searchKeyword}">${i}</a></li>
	                            </c:when>
	                            <c:otherwise>
	                                <li class="page-item"><a class="page-link" href="adminReceivedNotification?pageNum=${i}">${i}</a></li>
	                            </c:otherwise>
	                        </c:choose>
	                    </c:otherwise>
	                </c:choose>
	            ...
	            <c:choose>
	                ...
	                <c:when test="${pageNum < pageInfo.maxPage}">
	                	<c:choose>
	                		<c:when test="${not empty param.searchType and not empty param.searchKeyword}">
			                    <li class="page-item">
			                        <a class="page-link" aria-label="Next" href="adminReceivedNotification?pageNum=${pageNum + 1}&searchType=${param.searchType}&searchKeyword=${param.searchKeyword}">
	                		...
	                		<c:otherwise>
			                    <li class="page-item">
			                        <a class="page-link" aria-label="Next" href="adminReceivedNotification?pageNum=${pageNum + 1}">
			                            <span aria-hidden="true">&raquo;</span>
			                        </a>
			                    </li>
	                		</c:otherwise> 
