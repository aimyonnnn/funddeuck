                ...
                <c:when test="${pageNum > 1}">
                	<c:choose>
                		<c:when test="${not empty param.searchType and not empty param.searchKeyword}">
	                        <a class="page-link" aria-label="Previous" href="projectStatus?pageNum=${pageNum - 1}&searchType=${param.searchType}&searchKeyword=${param.searchKeyword}">
	                            <span aria-hidden="true">&laquo;</span>
	                        </a>
                		</c:when>
                		<c:otherwise>
	                        <a class="page-link" aria-label="Previous" href="projectStatus?pageNum=${pageNum - 1}&maker_idx=${param.maker_idx}&project_idx=${param.project_idx}">
	                            <span aria-hidden="true">&laquo;</span>
	                        </a>
                		</c:otherwise>
                	</c:choose>
            ...
            <c:forEach var="i" begin="${pageInfo.startPage}" end="${pageInfo.endPage}">
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <c:choose>
                            <c:when test="${not empty param.searchType and not empty param.searchKeyword}">
                                <li class="page-item"><a class="page-link" href="projectStatus?pageNum=${i}&searchType=${param.searchType}&searchKeyword=${param.searchKeyword}">${i}</a></li>
                            </c:when>
                            <c:otherwise>
                                <li class="page-item"><a class="page-link" href="projectStatus?pageNum=${i}&maker_idx=${param.maker_idx}&project_idx=${param.project_idx}">${i}</a></li>
                            </c:otherwise>
                        </c:choose>
                    </c:otherwise>
                </c:choose>
            ...
            <c:choose>
                ...
                <c:when test="${pageNum < pageInfo.maxPage}">
                	<c:choose>
                		<c:when test="${not empty param.searchType and not empty param.searchKeyword}">
		                    <li class="page-item">
		                        <a class="page-link" aria-label="Next" href="projectStatus?pageNum=${pageNum + 1}&searchType=${param.searchType}&searchKeyword=${param.searchKeyword}">
                		...
                		<c:otherwise>
		                    <li class="page-item">
		                        <a class="page-link" aria-label="Next" href="projectStatus?pageNum=${pageNum + 1}&maker_idx=${param.maker_idx}&project_idx=${param.project_idx}">
		                            <span aria-hidden="true">&raquo;</span>
		                        </a>
		                    </li>
                		</c:otherwise> 
